.PHONY: all compile xref eunit check_plt build_plt dialyzer doc callgraph graphviz clean distclean release
...
LIBS = deps/leo_commons/ebin deps/leo_backend_db/ebin
