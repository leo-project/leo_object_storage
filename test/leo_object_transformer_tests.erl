...
transform() ->
    ...
    #?OBJECT{key = Key,
             ...
             checksum = Checksum,
             ring_hash = RingHash,
             del = Del} = leo_object_storage_transformer:metadata_to_object(
                            #metadata{key = Key,
                                      addr_id = AddrId,
                                      ksize = KSize,
                                      dsize = DSize,
    ...
    #?METADATA{key = Key,
               ...
               checksum = Checksum,
               ring_hash = RingHash,
               del = Del} = leo_object_storage_transformer:object_to_metadata(
                              #object{key = Key,
                                      addr_id = AddrId,
                                      ksize = KSize,
                                      dsize = DSize,
    ...
    #?METADATA{key = Key,
               ...
               checksum = Checksum,
               ring_hash = RingHash,
               del = Del} = leo_object_storage_transformer:transform_metadata(
                              #metadata{key = Key,
                                        addr_id = AddrId,
                                        ksize = KSize,
                                        dsize = DSize,
    ...
    #?OBJECT{method = Method,
             ...
             ring_hash = RingHash,
             req_id = ReqId,
             del = Del} = leo_object_storage_transformer:transform_object(
                            #object{method = Method,
                                    key = Key,
                                    addr_id = AddrId,
                                    data = Data,
    ...
    ?assertEqual(SSEC_KeyHash, Metadata_1#?METADATA.ssec_key_hash),
    ?assertEqual(SSEC_IV, Metadata_1#?METADATA.ssec_iv),
